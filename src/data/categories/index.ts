...
const rawCategories: Category[] = [
  {
    ...
    subcategories: [
      ...
      { slug: 'fruehstueck', label: 'Frühstück & Brunch', listSlug: 'top-10-fruehstueck-und-brunch-in-stuttgart' },
      { slug: 'burger', label: 'Burgerläden', listSlug: 'top-10-burgerlaeden-in-stuttgart' },
      ...
      { slug: 'doener', label: 'Dönerläden', listSlug: 'top-10-doenerlaeden-in-stuttgart' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'sehenswurdigkeiten', label: 'Sehenswürdigkeiten', listSlug: 'top-10-sehenswuerdigkeiten-in-stuttgart' },
    ],
  },
  {
    slug: 'dienstleister',
  ...
  },
  {
    ...
    subcategories: [
      { slug: 'zahnarzte', label: 'Zahnärzte', listSlug: 'top-10-zahnaerzte-in-stuttgart' },
      { slug: 'physiotherapie', label: 'Physiotherapie', listSlug: 'top-10-physiotherapie-in-stuttgart' },
      { slug: 'orthopaden', label: 'Orthopäden', listSlug: 'top-10-orthopaeden-in-stuttgart' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'sanitarbetriebe', label: 'Sanitärbetriebe', listSlug: 'top-10-sanitaerbetriebe-in-stuttgart' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'mobelhauser', label: 'Möbelhäuser', listSlug: 'top-10-moebelhaeuser-in-stuttgart' },
  ...
  },
  {
    ...
    subcategories: [
      { slug: 'autowerkstatten', label: 'Autowerkstätten', listSlug: 'top-10-autowerkstaetten-in-stuttgart' },
      { slug: 'fahrschulen', label: 'Fahrschulen', listSlug: 'top-10-fahrschulen-in-stuttgart' },
      { slug: 'autohauser', label: 'Autohäuser', listSlug: 'top-10-autohaeuser-in-stuttgart' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'backereien', label: 'Bäckereien', listSlug: 'top-10-baeckereien-in-stuttgart' },
      { slug: 'feinkostladen', label: 'Feinkostläden', listSlug: 'top-10-feinkostlaeden-in-stuttgart' },
